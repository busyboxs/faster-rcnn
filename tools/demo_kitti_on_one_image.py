...
def generate_evaluate_txt(net, image_name):
    ...
    save_root = '/media/yangshun/0008EB70000B0B9F/roi_roi/txt_result/new/faster_rcnn/data'
...
if __name__ == '__main__':
    ...
    prototxt = '/media/yangshun/0008EB70000B0B9F/PycharmProjects/faster_rcnn/models/kitti/VGG16/' \
               'faster_rcnn_end2end_pedcyc/test.prototxt'
    caffemodel = '/media/yangshun/0008EB70000B0B9F/roi_roi/faster_rcnn_pedcyc2/kittivoc_train/' \
